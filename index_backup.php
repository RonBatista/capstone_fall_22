              ...
              button, which will then download a Zip file of the specified attributes and file formats.
                    ...
                    <div class = "row">
						...
						<div class="col-md-12" style="margin-top: 15px;">
                          ...
                          <div class="col-md-12" style="margin-top: 15px;">
                                        <div class="form-group">
                                            <label>Orthomosaic</label>
                                              <select name="orthomosaic" id="orthomosaic" class="form-control" onchange="showdiv('orthomosaic_attribute_table_div', this)">
                                                <option value="0" selected="selected">--Select an Orthomosiac File--</option>
                                              </select>
                                        </div>
                          </div>

                          <!-- Table for users to Select attributes to generate when an Orthomosiac file is selected-->
                          <div id="orthomosaic_attribute_table_div" class="col-lg-12">
                          ...
                          <table id="product-table-0" class="table table-bordered">
                            <thead style="">
                              <tr style="color: white; background: black;">
                                <th style="border: none;">
                                  <input id="check-all-ccExgTable" type="checkbox" checked="" onchange="ToggleAllRowData_ccExgTable();">
                                </th>
                            ...
                            <tbody id="product-list-0">
                              <tr>
                                <td style="">
                                  <input id="cc_cb" name="cc_cb" type="checkbox" value="CanopyCover" checked="" onchange="ToggleRowData_ccExgTable();">
                                </td>
                                <td style="">
                              ...
                              <tr>
                                <td style="">
                                  <input id="exg_cb" name="exg_cb" type="checkbox" value="Exg" checked="" onchange="ToggleRowData_ccExgTable();">
                                </td>
                                <td style="">
                                  <span>ExG</span>
                                </td>
                          ...
                          <div class="col-md-12" style="margin-top: 15px;">
                                        <div class="form-group">
                                            ...
                                            <select id="canopy_height_model" name="canopy_height_model" class="form-control" onchange="showdiv('chm_attribute_table_div', this)">
                                              <option value="0" selected="selected">--Select a Canopy Height Model File--</option>
                                            </select>
                                        </div>
                          </div>

                          <!--Select canopy attribute selection code-->
                  <div class="col-lg-12" id="chm_attribute_table_div">
                      <label>Select Canopy Attributes to Generate:</label>
                            ...
                            <table id="product-table-0" class="table table-bordered">
                              <thead style="">
                                <tr style="color: white; background: black;">
                                  <th style="border: none;">
                                    <input id="check-all-chCvTable" type="checkbox" checked="" onchange="ToggleAllRowData_chCvTable();">
                                  </th>
                                  <th style="border: none;">--Select All--</th>
                                </tr>
                              </thead>
                              <tbody id="product-list-0">
                                <tr>
                                  <td style="">
                                    <input id="ch_cb" name="ch_cb" type="checkbox" value="CanopyHeight" checked="" onchange="ToggleRowData_chCvTable();">
                                  </td>
                                  <td style="">
                                ...
                                <tr>
                                  <td style=""><input id="cv_cb" name="cv_cb" type="checkbox" value="CanopyVolume" checked="" onchange="ToggleRowData_chCvTable();"></td><td style="">
            ...
            <label>Select result files to download:</label>
                  ...
                  <table id="product-table-0" class="table table-bordered">
                    ...
                    <tbody id="product-list-0">
                      ...
                      <tr>
                        <td style="">
                          <input id="shp_cb" name="shp_cb" type="checkbox" checked="" onchange="ToggleRowData_formatsTable();">
                        </td>
                        <td style=""> <!--<td style=""><input id="check-data-2-84" name="check-data-2" type="checkbox" checked="" onchange="ToggleRowData(2);"></td><td style="">-->
                          <span>.shp</span>
                        </td>
                      </tr>
                    </tbody>
