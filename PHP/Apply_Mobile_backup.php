...
if (mysqli_connect_errno()) {
    ...
    if ($result) {
        ...
        if ($page) {
            ...
            //_log('page path mobile: ' . $page['PathMobile']);
            ...
            $sourcePath = str_replace($header_location . '/uashub/web/temp/mobile/', SetTempFolderLocalPathMobile(), $page["PathMobile"]);
            //_log('$sourcePath ' . $sourcePath);

            //$desPath = str_replace($main_temporary_folder . 'mobile/', SetVisualizationFolderLocalPathMobile(), $page["PathMobile"]);
...
//				$viewPath = str_replace("/var/www/html/wordpress/","http://basfhub.gdslab.org/temp/", $desPath);
            ...
            $viewPath = str_replace($root_path. 'web/', $header_location . '/', $desPath);
